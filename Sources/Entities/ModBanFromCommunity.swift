...
public struct ModBanFromCommunity: Codable {
    ...
    /// ModBanFromCommunity.reason
    public var reason: String?
    /// ModBanFromCommunity.banned
    public var isBanned: Bool
    /// ModBanFromCommunity.expires
    public var expires: String?
    /// ModBanFromCommunity.when_
    public var when: String

    public init(id: Double, modPersonID: Double, otherPersonID: Double, communityID: Double, reason: String? = nil, isBanned: Bool, expires: String? = nil, when: String) {
        self.id = id
